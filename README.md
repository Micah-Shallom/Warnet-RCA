...
scenarios/
  ...
  test_funding.py             # Test 1: wallet + funding verification
  test_htlc.py                # Test 2: HTLC output + multisig signing
  test_box_m.py               # Test 3: planted input + m_child
  test_htlc_timeout.py        # Test 4: Bob's timeout transaction
  test_preimage_replacement.py # Test 5: the core RBF replacement
  test_single_cycle.py        # Test 6: one complete cycle
  test_multi_cycle.py         # Test 7: multiple cycles
